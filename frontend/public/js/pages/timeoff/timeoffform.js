function renderTimeOffForm() {
  ...
  return `<div class="task-modal-overlay" id="leave-modal" style="display:none;">
    <div class="task-modal-card">
      <div class="task-modal-header"><h3 id="leave-modal-title">New Leave Request</h3><button class="icon-button" id="close-leave-modal" type="button">&times;</button></div>
      <form id="leave-form">
        <input type="hidden" id="leave-id" />
        <div class="form-section"><h4 class="form-section-title">Leave Details</h4><div class="form-grid">
          <label class="field-block full-width"><span id="leave-name-label">Leave Name <span class="required-indicator">*</span></span><input id="leave-name" required placeholder="Enter leave name" /></label>
        ...
        <div class="form-section"><h4 class="form-section-title">Date &amp; Status</h4><div class="form-grid">
          ...
          <label class="field-block full-width"><span id="leave-reason-label">Reason <span class="required-indicator">*</span></span><input id="leave-reason" required placeholder="Enter reason for leave" /></label>
